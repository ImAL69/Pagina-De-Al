...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-white text-black selection:bg-p-red selection:text-white">
        ...
        <footer className="p-8 border-t-4 border-black text-center font-bold uppercase italic tracking-tighter">
          <span className="bg-black text-white px-4 py-2 persona-slant inline-block">
